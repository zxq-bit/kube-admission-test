...
var (
	...
	// gvk = corev1.SchemeGroupVersion.WithKind(reflect.TypeOf(&corev1.PersistentVolumeClaim{}).Name())
)
...
func (c *PersistentVolumeClaimConfig) Register(opType arv1b1.OperationType, ps ...PersistentVolumeClaimProcessor) (errs []error) {
...
func (c *PersistentVolumeClaimConfig) ToConfig() (out *processor.Config) {
