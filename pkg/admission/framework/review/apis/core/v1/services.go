...
type ServiceProcessor struct {
	...
	Admit func(ctx context.Context, in *corev1.Service) (err error)
}
...
func (h *ServiceHandler) DoAdmit(ctx context.Context, tracer *tracer.Tracer, in runtime.Object) (cost time.Duration, err error) {
