...
var (
	...
	// gvk = appsv1.SchemeGroupVersion.WithKind(reflect.TypeOf(&appsv1.ReplicaSet{}).Name())
)
...
func (c *ReplicaSetConfig) Register(opType arv1b1.OperationType, ps ...ReplicaSetProcessor) (errs []error) {
...
func (c *ReplicaSetConfig) ToConfig() (out *util.Config) {
	out = &util.Config{
