...
type SecretProcessor struct {
	...
	Admit func(ctx context.Context, in *corev1.Secret) (err error)
}
...
func (h *SecretHandler) DoAdmit(ctx context.Context, tracer *tracer.Tracer, in runtime.Object) (cost time.Duration, err error) {
