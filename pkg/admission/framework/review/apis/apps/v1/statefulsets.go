...
type StatefulSetProcessor struct {
	...
	Admit func(ctx context.Context, in *appsv1.StatefulSet) (err error)
}
...
func (h *StatefulSetHandler) DoAdmit(ctx context.Context, tracer *tracer.Tracer, in runtime.Object) (cost time.Duration, err error) {
