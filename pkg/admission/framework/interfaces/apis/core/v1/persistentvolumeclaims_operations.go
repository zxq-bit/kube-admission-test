...
func (p *PersistentVolumeClaimProcessor) DoWithTracing(in *corev1.PersistentVolumeClaim) (cost time.Duration, err error) {
...
func (c *PersistentVolumeClaimConfig) ToConfig(filter processor.MetadataFilter) (out *processor.Config) {
	out = &processor.Config{
		GroupVersionResource: persistentvolumeclaimsGVR,
